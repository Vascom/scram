...
class Model
    : public Element,
      public MultiContainer<Model, InitiatingEvent, EventTree, Sequence,
                            Consequence, ConsequenceGroup, Rule, Alignment,
                            Substitution, FaultTree, BasicEvent, Gate,
                            HouseEvent, Parameter, CcfGroup, ExternLibrary,
                            ExternFunction<void>> {
 public:
